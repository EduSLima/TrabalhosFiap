...
precisao.tinto.pca = 10.10
precisao.tinto.chierarquico = 10.10

precisao.tinto = data.frame("Tecnica" = c("Regressao Linear",
                                     "Arvore de Regressao",
                                     "Arvore de Decisao",
                                     "Regressao Logistica",
                                     "PCA",
                                     "K-Means",
                                     "Cluster Hierarquico"),
                       "Acuracia" = c(as.numeric(precisao.tinto.rlinear),
                                      as.numeric(precisao.tinto.aregressao),
                                      as.numeric(precisao.tinto.adecisao),
                                      as.numeric(precisao.tinto.rlogistica),
                                      as.numeric(precisao.tinto.pca),
                                      as.numeric(precisao.tinto.kmeans),
                                      as.numeric(precisao.tinto.chierarquico)), 
                       stringsAsFactors = FALSE)

ggplot(precisao.tinto, aes(x=Tecnica, y=Acuracia, fill=Tecnica)) +
...
precisao.branco.pca = 10.10
precisao.branco.chierarquico = 10.10

precisao.branco = data.frame("Tecnica" = c("Regressao Linear",
                                     "Arvore de Regressao",
                                     "Arvore de Decisao",
                                     "Regressao Logistica",
                                     "PCA",
                                     "K-Means",
                                     "Cluster Hierarquico"),
                       "Acuracia" = c(as.numeric(precisao.branco.rlinear),
                                      as.numeric(precisao.branco.aregressao),
                                      as.numeric(precisao.branco.adecisao),
                                      as.numeric(precisao.branco.rlogistica),
                                      as.numeric(precisao.branco.pca),
                                      as.numeric(precisao.branco.kmeans),
                                      as.numeric(precisao.branco.chierarquico)), 
                       stringsAsFactors = FALSE)

ggplot(precisao.branco, aes(x=Tecnica, y=Acuracia, fill=Tecnica)) +
  geom_bar(stat="identity") +
  scale_fill_hue(c = 40)
