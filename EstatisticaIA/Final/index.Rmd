...
```{r chunk="idx_04_02" , echo=TRUE, eval=TRUE}
Modelo_02 <- lm(qualidade ~ grau_alcolico + acidez_volatil + sulfatos, data = df_vinho_tinto_treino)
...
df_vinho_tinto_treino$Predicao.Qualidade = predict(Modelo_02, newdata = subset(df_vinho_tinto_treino, select=c(qualidade, grau_alcolico, acidez_volatil, acido_citrico, sulfatos)))
...
### Teste do Segundo Modelo

```{r chunk="idx_04_02" , echo=TRUE, eval=TRUE}

df_vinho_tinto_teste$Predicao.Qualidade = predict(Modelo_02, newdata = subset(df_vinho_tinto_teste, select=c(qualidade, grau_alcolico, acidez_volatil, acido_citrico, sulfatos)))
